...
public class MeetingDTO implements Serializable {
	...
	public String toString() {
		return "MeetingDTO [id=" + id + ", title=" + title + ", submitter="
				+ submitter + ", aliasUsed=" + aliasUsed + ", startDate="
				+ startDate + ", endDate=" + endDate + ", uid=" + uid
				+ ", tags=" + tags + ", partners=" + partners + ", userId="
				+ userId + ", userLogin=" + userLogin + ", userFirstName="
				+ userFirstName + ", userLastName=" + userLastName + ", mTag="
				+ mTag + ", mPartner=" + mPartner + "]";
	}
}
