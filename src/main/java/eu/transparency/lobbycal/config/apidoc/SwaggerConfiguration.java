package eu.transparency.lobbycal.config.apidoc;
...
public class SwaggerConfiguration {
	...
	public Docket swaggerSpringfoxDocket(JHipsterProperties jHipsterProperties) {
		...
		watch.start();
		ApiInfo apiInfo = new ApiInfo(jHipsterProperties.getSwagger()
				.getTitle(), jHipsterProperties.getSwagger().getDescription(),
