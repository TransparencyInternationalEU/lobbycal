...
import eu.transparency.lobbycal.web.filter.gzip.GZipServletFilter;
...
//		initLogbackStatusViewer(servletContext, disps);
	...
	private void initLogbackStatusViewer(ServletContext servletContext,
			EnumSet<DispatcherType> disps) {

		log.debug("Initializing log viewer ");
		ServletRegistration.Dynamic logServlet = servletContext
				.addServlet("logViewer", new ViewStatusMessagesServlet());
		logServlet.addMapping("/logbackstatus/*");
