...
public class AccountResourceTest {
	...
	public void setup() {
		...
		doNothing().when(mockMailService).sendActivationEmail(
				(User) anyObject(), anyString());
	...
	public void testRegisterValid() throws Exception {
		UserDTO u = new UserDTO("joe", // login
				...
				true, // activated
				"en", // langKey
				new HashSet<>(Arrays.asList(AuthoritiesConstants.USER)), null);
	...
	public void testRegisterAdminIsIgnored() throws Exception {
		UserDTO u = new UserDTO("badguy", // login
				...
				true, // activated
				"en", // langKey
				new HashSet<>(Arrays.asList(AuthoritiesConstants.ADMIN)) ,null// <--
																			// only
																			// admin
																			// should
																			// be
